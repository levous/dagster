...
class CachingRepositoryData(RepositoryData):
    ...
    def from_list(
        ...
        Args:
            repository_definitions (List[Union[AssetsDefinition, SourceAsset, PipelineDefinition, PartitionSetDefinition, ScheduleDefinition, SensorDefinition, GraphDefinition]]):
