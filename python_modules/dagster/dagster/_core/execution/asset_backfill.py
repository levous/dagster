...
def execute_asset_backfill_iteration(
    ...
    pipeline_and_execution_plan_cache: Dict[
        str, Tuple[ExternalPipeline, ExternalExecutionPlan]
    ] = {}
...
def submit_run_request(
    ...
    pipeline_and_execution_plan_cache: Dict[str, Tuple[ExternalPipeline, ExternalExecutionPlan]],
) -> None:
    ...
    selector_id = pipeline_selector.get_id()
